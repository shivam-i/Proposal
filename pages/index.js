...
export default function Home() 
{
  ...
  return (
    <>
      ...
      <div className="flex flex-row justify-center items-center w-full h-full bg-blue-200 p-10 drop-shadow-xl">
        <div className="w-2/3 h-64 bg-gradient-to-r from-blue-300 to-blue-200 drop-shadow-xl rounded-full text-center transition-all duration-300">
          <h1 className="p-20 tracking-wide text-8xl font-bold text-white uppercase drop-shadow-lg">Hi Beautiful</h1>
        </div>
      </div>

      <div className="flex flex-row items-center justify-evenly w-full h-96 bg-blue-50">
        <CommentedImage src='/san1.jpg' text="wow so pretty"/>
        <CommentedImage src='/san2.jpg' text="omg we&apos;re so cute"/>
        <CommentedImage src='/san3.jpg' text="we should kiss?"/>
      </div>

      <div className="text-center w-full h-64 bg-blue-200 drop-shadow-xl">
        <h1 className="p-20 tracking-wide text-6xl font-bold text-blue-400 uppercase drop-shadow-xl">So I heard...</h1>
      </div>

      <div className="flex flex-col items-center text-center w-full h-96 bg-blue-50 p-10">
        <div className="flex flex-row items-center text-center w-full h-5/6 bg-blue-50">
          <h1 className='w-1/3 text-blue-300 font-bold text-6xl'>You Need</h1>
          ...
          <h1 className='w-1/3 text-blue-300 font-bold text-6xl'>Some</h1>
        </div>
        <h1 className="w-full h-1/4 text-blue-300 font-bold text-6xl uppercase">LOVE?</h1>
      </div>

      <div className="text-center w-full h-64 bg-blue-200 drop-shadow-xl">
        <h1 className="p-20 tracking-wide text-6xl font-bold text-blue-400 uppercase drop-shadow-xl">So...</h1>
      </div>

      <CornyQuestion 
        question="They say nothing lasts forever, so will you be my nothing?"
        nonactive="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/Nuclear_symbol.svg/1024px-Nuclear_symbol.svg.png"
        active="https://hips.hearstapps.com/hmg-prod/images/best-love-quotes-of-all-time-envelope-with-hearts-1611079864.jpg?crop=0.662xw:0.993xh;0.00163xw,0.00733xh&resize=1200:*"
        primary
        left
      />

      <div className="flex flex-row justify-around items-center text-center w-full h-96 bg-blue-200 p-5">
        <h1 className='w-2/3 text-blue-400 font-bold text-6xl'>Would you</h1>
      </div>

      <div className="flex flex-row justify-around items-center text-center w-full h-96 bg-blue-50 p-5">
        <h1 className='w-2/3 text-blue-300 font-bold text-6xl'>Uh</h1>
      </div>
      ...
      <div className="flex flex-row justify-around items-center text-center w-full h-96 bg-blue-50 px-5 pt-5">
        <h1 className='w-2/3 text-blue-400 font-bold text-6xl'>If I&apos;m C would you be my C++ for life?</h1>
      </div>

      <div className="flex flex-row justify-around items-start text-center w-full h-36 bg-blue-50 pb-5">
        <RandomButton 
          text="No"
          minHeight={ 4600 }
          maxHeight={ 5000 }
        ...
        <button 
          className="w-36 bg-blue-400 text-white text-2xl p-5 rounded-2xl"
          onClick={ onOpen }
        >
          YES
        </button>
      ...
      {
        confirmed ? 
        <div className="flex flex-col justify-around items-center text-center w-full h-[58em] bg-blue-200 p-5">
          <h1 className='w-2/3 text-blue-400 font-bold text-6xl'>Confirmation Receipt</h1>
